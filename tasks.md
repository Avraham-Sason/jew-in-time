...
- [x] ✅ עדכון מחרוזות i18n שמכילות את שם האפליקציה
  **מה זה:** סריקה של `i18n/he.json` ו-`i18n/en.json` למפתחות שמכילים "יהודי כשר" / "Kosher Jew" (למשל `appName`, hero של onboarding, About). החלפה ל-"יהודי בזמן" / שווה-ערך באנגלית.
